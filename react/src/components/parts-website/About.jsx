    ...
    return (
        <section className='w-full min-h-0 bg-orange-200 p-1'>
            <div className='w-11/12 min-h-0 m-auto'>
                ...
                <div className='w-full min-h-0 flex items-center justify-evenly'>
                    ...
                    <img className='w-2/5' src="http://localhost:5173/img/Logo.png" alt="About1" />
                </div>

                <div className='w-full min-h-0 flex items-center justify-evenly'>
                    <img className='w-2/5' src="http://localhost:5173/img/About2.png" alt="About2" />
                    <p className='w-2/5 text-justify'>
