...
export const Banner = () => {
  return (
    <section className='relative w-full h-[31rem] flex items-center justify-evenly'>
        ...
        <img className='w-[35rem] z-40' src="http://localhost:5173/img/About1.png" alt="Pizza" />
        <div className='w-2/5 h-full z-40 p-5 flex flex-col items-center justify-evenly'>
