    ...
    return (
        <footer class="bg-red-100">
            <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div class="relative py-10 sm:flex sm:items-center sm:justify-between">
                    <img className='absolute w-48' src="http://localhost:5173/img/Logo.png" alt="Logo" />


                    <ul class="absolute right-0 flex justify-start gap-6 sm:mt-0 sm:justify-end">
                        <li>
                            <a
                                href="/"
                                rel="noreferrer"
